...
| Özellik | Detay |
|---------|-------|
| **Telefon** | Samsung Galaxy J5 (2015) SM-J500F |
| **İşlemci** | Snapdragon 410 Quad-core 1.2 GHz |
| **RAM** | 1.5 GB |
...
> İndir: [github.com/termux/termux-app/releases](https://github.com/termux/termux-app/releases)
...
|-------|----------|
| `merhaba` | Karşılama |
| `saat kac` | Saati söyler |
| `pil durumu` | Pil yüzdesini gösterir |
| `fener ac` / `fener kapat` | Fener kontrolü |
| `ara 05321234567` | Telefon araması |
| `mesaj gonder` | SMS gönderir |
| `ac youtube` | Uygulama açar |
| `hava durumu istanbul` | Hava durumu bilgisi |
| `parlaklik 150` | Ekran parlaklığı (0-255) |
| `not al toplanti yarin` | Not kaydeder |
| `notlari oku` | Notları listeler |
| `kuantum fiziği nedir` | Gemini AI yanıt verir |
...
- [ ] TTS ses çıkışı sorununun çözülmesi
- [ ] Alarm ve hatırlatıcı sistemi
- [ ] Müzik çalma kontrolü
- [ ] Akıllı ev cihazları entegrasyonu (ESP8266)
- [ ] Sürekli dinleme modu (wake word)
